...
pub static mut GetAttachedShaders: FnPtr = FnPtr {
            ...
            pub mod GetFloati_v {
                ...
                pub fn load_with<F>(mut loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::GetFloati_v = FnPtr::new(metaloadfn(&mut loadfn, "glGetFloati_v", &["glGetFloatIndexedvEXT", "glGetFloati_vEXT", "glGetFloati_vNV"]))
                    }
                }
            }
            ...
            pub mod ViewportIndexedf {
                ...
                pub fn load_with<F>(mut loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::ViewportIndexedf = FnPtr::new(metaloadfn(&mut loadfn, "glViewportIndexedf", &["glViewportIndexedfNV"]))
                    }
                }
            }
            ...
            pub mod ViewportArrayv {
                ...
                pub fn load_with<F>(mut loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::ViewportArrayv = FnPtr::new(metaloadfn(&mut loadfn, "glViewportArrayv", &["glViewportArrayvNV"]))
                    }
                }
            }
            ...
            pub mod ScissorIndexedv {
                ...
                pub fn load_with<F>(mut loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::ScissorIndexedv = FnPtr::new(metaloadfn(&mut loadfn, "glScissorIndexedv", &["glScissorIndexedvNV"]))
                    }
                }
            }
            ...
            pub mod ScissorIndexed {
                ...
                pub fn load_with<F>(mut loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::ScissorIndexed = FnPtr::new(metaloadfn(&mut loadfn, "glScissorIndexed", &["glScissorIndexedNV"]))
                    }
                }
            }
            ...
            pub mod DrawTransformFeedback {
                ...
                pub fn load_with<F>(mut loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::DrawTransformFeedback = FnPtr::new(metaloadfn(&mut loadfn, "glDrawTransformFeedback", &["glDrawTransformFeedbackNV"]))
                    }
                }
            }
            ...
            pub mod ClearTexSubImage {
                ...
                pub fn load_with<F>(mut loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::ClearTexSubImage = FnPtr::new(metaloadfn(&mut loadfn, "glClearTexSubImage", &[]))
                    }
                }
            }
            ...
            pub mod ViewportIndexedfv {
                ...
                pub fn load_with<F>(mut loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::ViewportIndexedfv = FnPtr::new(metaloadfn(&mut loadfn, "glViewportIndexedfv", &["glViewportIndexedfvNV"]))
                    }
                }
            }
            ...
            pub mod ScissorArrayv {
                ...
                pub fn load_with<F>(mut loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::ScissorArrayv = FnPtr::new(metaloadfn(&mut loadfn, "glScissorArrayv", &["glScissorArrayvNV"]))
                    }
                }
            }
            ...
            pub mod ClearTexImage {
                ...
                pub fn load_with<F>(mut loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::ClearTexImage = FnPtr::new(metaloadfn(&mut loadfn, "glClearTexImage", &[]))
                    }
                }
            }
            ...
            pub mod DrawTransformFeedbackInstanced {
                ...
                pub fn load_with<F>(mut loadfn: F) where F: FnMut(&str) -> *const raw::c_void {
                    unsafe {
                        storage::DrawTransformFeedbackInstanced = FnPtr::new(metaloadfn(&mut loadfn, "glDrawTransformFeedbackInstanced", &[]))
                    }
                }
            }
